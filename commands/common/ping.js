...
class PingCommand extends Command {
  ...
  async run(message) {
    ...
    await Message.edit(`I took **${Message.createdTimestamp - message.createdTimestamp}ms** to find and eat all insects! <:KannaOh:315264555859181568> ~~**(WS: ${Math.floor(this.client.ping)}ms)**~~`);
  }
}
